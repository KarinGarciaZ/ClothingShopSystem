...
Public Class VentasPorPeriodo
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        CONEXION.Open()
        Dim cmd As New SqlCommand("VentasPorPeriodo", CONEXION)
        cmd.CommandType = CommandType.StoredProcedure
        Dim adaptador As New SqlDataAdapter()
        adaptador.SelectCommand = New SqlCommand
        adaptador.SelectCommand.Connection = CONEXION
        adaptador.SelectCommand.CommandText = "VentasPorPeriodo"
        ...
        Reporte.Reportito.LocalReport.ReportPath = obtenerRutaReportes() & "\ReporteVentasPeriodo.rdlc"
